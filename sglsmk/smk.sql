...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`smk` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `tb_user`(`id`,`username`,`password`,`role`) values (16,'admin','admin','admin'),(19,'zhangfei','123','admin');
