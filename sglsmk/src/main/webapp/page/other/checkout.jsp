        ...
        <div class="sidebar-scroll">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active"><a href="/toCheckout"><i class="icon-calendar"></i><span>结算服务</span></a></li>
        ...
        <div class="container">
            ...
            <div style="width: 80%; margin: 0 auto; height: 30px;">
                <form class="form-inline" action="${APP_PATH}/product/checkPlusPro" method="post">
                    ...
                    <div class="col-sm-4 col-sm-offset-4" style="width: 23%;padding: 10px;alignment: center">
                        <c:if test="${ERROR != null && ERROR_INFO != ''}">
